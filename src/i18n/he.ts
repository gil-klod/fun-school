...
export const he: Dictionary = {
  ...
  home: {
    ...
    demoSubtitle: "חמש שאלות לדוגמה ממשחקים שונים",
    demoNotice: "זה רק דמו — הירשמו כדי לשחק בכל המשחקים ולשמור התקדמות!",
    demoProgress: "שאלה {current} מתוך {total}",
    demoCorrect: "נכון! 🎉",
    demoWrong: "התשובה הייתה: {answer}",
    demoNext: "דמו הבא →",
    demoFinish: "מה עוד יש? →",
    demoAllDone: "זה הדמו!",
    demoAllDoneHint: "הירשמו למאות שאלות נוספות, כל הנושאים, ושמירת התקדמות.",
    demoRestart: "נסו שוב את הדמו",
    demoRegister: "הירשמו כדי לשחק",
    demoRegisterHint: "הרשמה חינם · מעקב התקדמות · כל המשחקים פתוחים",
    demoPlayNow: "ללוח ההתקדמות שלי",
  },
  auth: {
  ...
  projects: {
    ...
    projectCompleteBody: "השלמת את כל ימי הפרויקט. את/ה כוכב/ית! ⭐",
    name: "שם הפרויקט",
    days: "ימים",
  ...
  games: {
    ...
    total: "סה\"כ:",
    youPay: "אתה משלם:",
    whichWordWrong: "מה המילה הנכונה?",
    findMistake: "בחר את המילה הנכונה במקום המילה המסומנת:",
    ...
    sequencesWrong: "המספר/ים החסר/ים: {answer}.",
    ...
    fixCorrect: "נכון!",
    fixWrong: "המילה הנכונה הייתה: \"{word}\"",
    ...
    wordCategoryColor: "צבע",
    wordCategoryNumber: "מספר",
    wordCategoryShape: "צורה",
    wordCategoryFood: "אוכל",
    wordCategoryVehicle: "רכב",
    wordCategoryAnimal: "חיה",
    wordCategoryBody: "גוף",
    wordCategoryClothing: "בגד",
    wordCategorySchool: "בית ספר",
    wordCategoryWeather: "מזג אוויר",
    wordCategoryHome: "בית",
    wordCategorySport: "ספורט",
