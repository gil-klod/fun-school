...
export const en: Dictionary = {
  ...
  home: {
    ...
    demoSubtitle: "Five sample questions from different games",
    demoNotice: "Demo only — register to play all games and save your progress!",
    demoProgress: "Question {current} of {total}",
    demoCorrect: "Correct! 🎉",
    demoWrong: "The answer was: {answer}",
    demoNext: "Next demo →",
    demoFinish: "See what's next →",
    demoAllDone: "That's the demo!",
    demoAllDoneHint: "Register for hundreds more questions, all subjects, and saved progress.",
    demoRestart: "Try the demo again",
    demoRegister: "Register to play",
    demoRegisterHint: "Free to join · track progress · all games unlocked",
    demoPlayNow: "Go to my progress",
  },
  auth: {
  ...
  projects: {
    ...
    projectCompleteBody: "You completed every day of the project. You're a star! ⭐",
    name: "Project name",
    days: "Days",
  ...
  subjects: {
    math: {
      ...
      games: {
        ...
        division: { title: "Fair Share", description: "Split into equal groups!" },
      },
    },
    hebrew: {
      title: "Hebrew",
  ...
  games: {
    ...
    total: "Total:",
    youPay: "You pay:",
    whichWordWrong: "What is the correct word?",
    findMistake: "Pick the right word for the highlighted mistake:",
    ...
    sequencesWrong: "The missing number(s) were {answer}.",
    nextSequence: "Next Sequence →",
    sequencesFillOne: "Fill in the missing number",
    sequencesFillTwo: "Fill in the two missing numbers (pick the pair)",
    ...
    fixCorrect: "Correct!",
    fixWrong: "The correct word was: \"{word}\"",
    ...
    wordCategoryColor: "Color",
    wordCategoryNumber: "Number",
    wordCategoryShape: "Shape",
    wordCategoryFood: "Food",
    wordCategoryVehicle: "Vehicle",
    wordCategoryAnimal: "Animal",
    wordCategoryBody: "Body",
    wordCategoryClothing: "Clothing",
    wordCategorySchool: "School",
    wordCategoryWeather: "Weather",
    wordCategoryHome: "Home",
    wordCategorySport: "Sport",
