...
export const MYSTERY_TEMPLATES: MysteryTemplate[] = [
  ...
  },
  {
    ...
    textHe: "לדני היו כמה ממתקים. הוא קיבל עוד {n}. עכשיו יש לו {result}. כמה היו לו בהתחלה?",
    hint: "Subtract {n} from {result}",
    hintHe: "חסר {n} מ-{result}",
  },
  {
    op: "subtract",
    minDifficulty: 1,
    text: "There were some balls in the classroom. {n} balls were taken outside. {result} balls stayed inside. How many balls were there at first?",
    textHe:
      "בכיתה היו כמה כדורים. הוציאו {n} כדורים לחצר. {result} כדורים נשארו בכיתה. כמה כדורים היו בהתחלה?",
    hint: "Add {n} to {result}",
    hintHe: "הוסף {n} ל-{result}",
  },
  {
  ...
  },
  {
    ...
    textHe: "בספרייה היו ספרים. {n} ספרים הושאלו. {result} ספרים נשארו. כמה ספרים היו?",
    hint: "Add {n} to {result}",
    hintHe: "הוסף {n} ל-{result}",
  },
  {
