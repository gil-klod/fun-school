...
> = {
  he: {
    home: genderLines([
      {
        ...
        female: "אני מיילו! קדימה, נושא, — אני כבר מחזיקה את התשובות. סתם, לא באמת.",
      },
      "ארבעה נושאים, הרבה משחקים, ואפס שיעורי בית משעממים!",
      {
        male: "טיפ מיילו: התחל מחשבון, — שם המספרים לא מתווכחים. בניגוד לי.",
        female: "טיפ מיילו: התחילי מחשבון, — שם המספרים לא מתווכחים. בניגוד לי.",
      },
    ]),
    dashboard: genderLines([
      "הנה ההתקדמות! עבודה יפה, — כך ממשיכים!",
      "סטטיסטיקות! נשמע מבוגר, אבל הגרפים צבעוניים.",
      {
        male: "אם המספרים נמוכים, — זה רק כי לא שיחקת עדיין היום!",
        female: "מספרים נמוכים? אולי פשוט לא היה זמן לשחק היום!",
      },
    ]),
    "subject.math": genderLines([
      "חשבון! המקום שבו מספרים לא מתלוננים. בניגוד לי.",
      "כפל, שוק וחידות, — מתמטיקה יכולה להיות כיף!",
      {
        male: "בוא, נראה אם הכפל יכול לעמוד בקצב!",
        female: "בואי, נראה אם הכפל יכול לעמוד בקצב!",
      },
    ]),
    ...
    "subject.english-beginners": genderLines([
      {
        male: "זמן אנגלית! אל תדאג, — גם אני מתבלבל לפעמים.",
        female: "זמן אנגלית! אין לחץ, — גם אני מתבלבל לפעמים.",
      },
    ...
    "game.math.multiplication": genderLines([
      "טבלאות כפל! מספרים שחוזרים שוב ושוב.",
      "בוס הכפל לא מפחיד. רק נראה רציני בגלל החרב.",
      {
        male: "שבע כפול שמונה? קל. שש כפול שבע? תן לי שנייה, אתה קודם!",
        female: "שבע כפול שמונה? קל. שש כפול שבע? נתחיל מהשאלה הזו — רגע!",
      },
    ]),
    "game.math.shuk": genderLines([
      {
        male: "שוק! קנה, שלם, קבל עודף, — ואל תשכח לחייך לירקן.",
        female: "שוק! קניות, תשלום, עודף, — ותמיד חיוך לירקן!",
      },
    ...
    "game.math.analog-clock": genderLines([
      ...
      {
        male: "מה השעה? לא, אל תסתכל על הטלפון!",
        female: "מה השעה? לא, בלי להסתכל בטלפון!",
      },
    ...
    "game.math.division": genderLines([
      ...
      "חלוקה שווה, — כמו פיצה ביום הולדת!",
      { male: "כמה לכל אחד? זו השאלה!", female: "כמה לכל אחד? זו השאלה!" },
    ]),
    "game.hebrew.scramble": genderLines([
      "ערבוב אותיות! מ-כ-ח-ו-ל ל... משהו כחול. כנראה.",
      "אותיות מבולבלות? אני מרגיש בבית.",
      { male: "אם זה נראה כמו כלב, — בדוק שוב!", female: "אם זה נראה כמו כלב, — תבדקי שוב!" },
    ]),
    "game.hebrew.fix-sentence": genderLines([
      "איזו מילה לא שייכת? כמו חתול במקלחת.",
      {
        male: "תקן את המשפט, — המורה תגיד יופי. אולי.",
        female: "מצאי את הטעות, — המורה תהיה מרוצה. אולי.",
      },
    ...
    "game.english-beginners.vocabulary": genderLines([
      {
        male: "חיבור מילים! תרגום נכון לכל מילה, — ועוד נקודה!",
        female: "חיבור מילים! תרגום מדויק לכל מילה, — ועוד נקודה!",
      },
    ...
    "game.english-beginners.sentences": genderLines([
      {
        male: "הרכב משפט! סדר את המילים, — אני סומך עליך.",
        female: "מילים למשפט! — אני בטוחה שתצליחי!",
      },
      "סדר מילים כמו קוביות, — רק בלי לדרוך עליהן.",
      "משפט מסודר — נקודות וניצחון!",
    ]),
    ...
    default: genderLines([
      ...
      {
        male: "אני כאן בשבילך, — אבל לא עובד במקומך.",
        female: "אני כאן לעזור, — אבל העבודה לא עליי!",
      },
      {
        male: "קדימה, נתחיל! המוח מודה!",
        female: "קדימה, נתחיל! המוח מודה!",
      },
    ]),
  },
  en: {
    ...
    dashboard: [
      "Your progress! Nice work — keep it up!",
