  ...
  he: {
    ...
    dashboard: genderLines([
      ...
      "סטטיסטיקות! נשמע מבוגר, אבל הגרפים צבעוניים.",
      {
        ...
        female: "מספרים נמוכים? אולי פשוט לא התחלת לשחק היום!",
      },
    ]),
    "subject.math": genderLines([
      ...
      {
        male: "בוא, נראה אם הכפל יכול לעמוד בקצב שלך!",
    ...
    "game.math.multiplication": genderLines([
      ...
      "בוס הכפל לא מפחיד. רק נראה רציני בגלל החרב.",
      {
        ...
        female: "שבע כפול שמונה? קל. שש כפול שבע? קודם את, רגע אחד!",
      },
    ]),
    ...
    "game.english-beginners.sentences": genderLines([
      {
        ...
        female: "סדרי מילים למשפט! — אני בטוחה שתצליחי!",
      },
    ...
    default: genderLines([
      ...
      },
      {
        ...
        female: "אני כאן לעזור, — אבל את עושה את העבודה!",
      },
      {
        male: "יאללה, נתחיל! המוח שלך מודה לי.",
